...
public class HomeController {
	private iTicketCommand ticketCommandBean_AutoWired;
	...
	@Autowired
	public void setTicketCommandBean_AutoWired(iTicketCommand ticketCommandBean_AutoWired) {
		this.ticketCommandBean_AutoWired = ticketCommandBean_AutoWired;
	}
	...
	public String buy_ticket_card(TicketDto ticketDto, Model model) {
		...
		ticketCommandBean_AutoWired.execute(ticketDto);
